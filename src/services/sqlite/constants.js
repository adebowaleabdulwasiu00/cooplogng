...
export const TABLE_COLUMNS = {
    ...
    remittance: ['id', 'cooperative_id', 'member_id', 'amount', 'bank_name', 'description', 'transaction_type', 'category', 'status', 'remittance_date', 'created_by', 'created_at', 'modified_by', 'modified_at', 'is_deleted', 'is_synced', 'sync_at', 'deleted_at', 'reconciliation_summary_id', 'autogen', 'loan_id', 'isWithdrawalRequest'],
