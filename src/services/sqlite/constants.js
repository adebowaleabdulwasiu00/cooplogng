export const TABLES = [
    ...
    'payment_advise', 'bank_reconciliation_summary', 'feedback', 'app_settings'
]

export const TABLE_COLUMNS = {
    cooperatives: ['id', 'full_name', 'short_name', 'contact_number', 'email', 'address', 'logo_path', 'coop_first_month', 'subscription_key', 'expiry_date', 'created_at', 'created_by', 'modified_at', 'modified_by', 'deleted_at', 'is_deleted', 'is_synced', 'sync_at', 'is_extracted'],
    users: ['id', 'cooperative_id', 'username', 'username_lower', 'password_hash', 'force_password_change', 'role', 'permissions', 'enterprise_rights', 'subscriptionStatus', 'expiry_date', 'created_at', 'created_by', 'modified_at', 'modified_by', 'deleted_at', 'is_synced', 'is_deleted', 'sync_at', 'email', 'email_lower', 'firebase_uid'],
    sync_queue: ['id', 'entity', 'entity_id', 'status', 'attempt_count', 'last_error', 'last_attempt_at', 'created_at', 'updated_at', 'collection_name', 'document_id', 'operation_type', 'merged_document', 'cooperative_id', 'next_attempt_at'],
    sync_state: ['cooperative_id', 'last_sync_ts', 'schema_version', 'is_full_sync_complete', 'last_sync_scope', 'collections', 'collection_cursors'],
    loans: ['id', 'cooperative_id', 'member_id', 'enterprise_id', 'principal_amount', 'issued_date', 'due_date', 'status', 'notes', 'created_at', 'created_by', 'modified_at', 'modified_by', 'deleted_at', 'is_synced', 'is_deleted', 'sync_at', 'admin_fee_id', 'duration_months', 'remittance_id', 'approved_at'],
    ...
    members: ['id', 'cooperative_id', 'last_name', 'first_name', 'middle_name', 'mobile', 'address', 'nok_name', 'nok_mobile', 'nok_address', 'sex', 'status', 'image_path', 'signature_path', 'registration_no', 'registration_no_str', 'special_id', 'special_id_lower', 'bank_name', 'account_number', 'account_name', 'date_joined', 'account_manager', 'created_at', 'created_by', 'modified_at', 'modified_by', 'deleted_at', 'account_balance', 'account_balance_total', 'is_synced', 'is_deleted', 'sync_at', 'password_hash', 'force_password_change', 'device_id', 'ip_address', 'country', 'state', 'city', 'latitude', 'longitude', 'timezone', 'browser', 'browser_version', 'operating_system', 'screen_resolution', 'device_type', 'device_name', 'subscriptionStatus', 'expiry_date', 'email', 'email_lower', 'firebase_uid', 'last_login', 'login_count'],
    ...
    remittance: ['id', 'cooperative_id', 'member_id', 'amount', 'bank_name', 'description', 'transaction_type', 'category', 'status', 'remittance_date', 'created_by', 'created_at', 'modified_by', 'modified_at', 'is_deleted', 'is_synced', 'sync_at', 'deleted_at', 'reconciliation_summary_id', 'autogen', 'loan_id', 'isWithdrawalRequest', 'isLoanRequest', 'parent_remittance_id'],
